...
def create_result_subdir(result_dir, desc):
    ...
    if not os.path.isdir(result_dir):
        ...
        print("Build directory..", flush=True)
    else:
        result_subdir = result_dir
        print("Directory already exists and will be used..", flush=True)
    '''
    else:
        while True:
            run_id = 0
            ...
            #Changed so that only run_id in name
            ...
            try:
                ...
                raise
    '''
    print("Saving results to", result_subdir, flush=True)
