...
def evaluate_metrics(run_id, log, metrics, num_images, real_passes, minibatch_size=None):
    ...
    for name in metrics:
        ...
        if name == 'fid':
            ...
            from metrics.sliced_wasserstein import API as class_def 
        elif name == 'is':
            from metrics.inception_score import API as class_def 
        elif name == 'mssim':
            from metrics.ms_ssim import API as class_def 
