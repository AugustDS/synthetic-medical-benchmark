...
def train(model_dir, results_dir, random_seed, resolution):
    ...
    output_dir  = os.path.join(results_dir, "classification_results/train")
    ...
    try:
        ...
        tfrecord_dir_tr = os.path.join(results_dir, "inference/train")
        tfrecord_dir_vl = os.path.join(results_dir, "inference/valid")
